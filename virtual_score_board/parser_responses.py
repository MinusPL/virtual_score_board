...
class Pong(Response):
    descriptions = ["Do you want to play table-tennis with me?", "Smash!", "You are very good!", "Pong",
                    "Are not you tired?", "Ha ha!", "1:0 for me!", "Girls will be throwing their bras for this!", "Hello, it's me", "What whether we have today?", "Have you ever seen the rain?", "Let's play the game", "You are now wanted, in all US states", "It's lunch time", "More then one animal: Lama", "Sheep?"]
